...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xff4c3e75),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff64558f),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff73649f),
      ...
      inverseSurface: Color(0xff322f35),
      inversePrimary: Color(0xffcfbdfe),
      primaryFixed: Color(0xff73649f),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff5b4c85),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff706a80),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff585267),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff8e606f),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff734857),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffb58393),
      ...
      primaryFixed: Color(0xffe8ddff),
      onPrimaryFixed: Color(0xff15033d),
      primaryFixedDim: Color(0xffcfbdfe),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xffcfbdfe),
      onPrimaryFixedVariant: Color(0xff15033d),
      secondaryFixed: Color(0xffe8def8),
      ...
      tertiaryFixedDim: Color(0xffefb8c8),
      onTertiaryFixedVariant: Color(0xff240613),
      surfaceDim: Color(0xff141218),
